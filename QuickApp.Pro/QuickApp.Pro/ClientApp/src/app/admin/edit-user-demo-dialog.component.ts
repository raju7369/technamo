...
import { UserEditorComponent } from './user-demo-editor.component';

@Component({
  selector: 'app-edit-user-dialog',
  templateUrl: 'edit-user-demo-dialog.component.html',
  styleUrls: ['edit-user-demo-dialog.component.scss']
})
